            ...
            children: [
              Container(
                decoration: BoxDecoration(  gradient:
                                                  LinearGradient(colors: [ const Color.fromARGB(255, 189, 185, 185),  const Color.fromARGB(255, 189, 185, 185)]),
                                              boxShadow: [
                                                BoxShadow(
                                                  color: const Color.fromARGB(197, 134, 132, 132), // White shadow color
                                                  spreadRadius:
                                                      2, // Spread radius
